...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { deathsTotal: @pledge.deathsTotal, diedWeek: @pledge.diedWeek, killsTotal: @pledge.killsTotal, killsWeek: @pledge.killsWeek, name: @pledge.name, smallGroup: @pledge.smallGroup }
    end
  ...
  test "should update pledge" do
    patch :update, id: @pledge, pledge: { deathsTotal: @pledge.deathsTotal, diedWeek: @pledge.diedWeek, killsTotal: @pledge.killsTotal, killsWeek: @pledge.killsWeek, name: @pledge.name, smallGroup: @pledge.smallGroup }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
